...
|---|---|---|
| Název Naplň Gym | schváleno | hlavní značka |
...
| FAQ | schváleno | pět otázek z briefu |
| Founder jméno a quote | schváleno | Vítězslav Čejka + dodaný citát |
| Founder fotografie | chybí | dodat před ostrým spuštěním |
| Finální logo asset | chybí | dočasně geometrická rekonstrukce podle briefu |
| Booking URL | chybí | připravené centrální konfigurační místo |
| Firemní e-mail | chybí | placeholder před spuštěním nahradit |
